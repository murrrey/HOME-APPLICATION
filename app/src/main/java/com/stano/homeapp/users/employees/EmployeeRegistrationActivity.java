...
import com.stano.homeapp.users.employers.EmployerRegistrationActivity;
...
public class EmployeeRegistrationActivity extends AppCompatActivity {
    private static final String TAG =
            "TAG :: " + EmployeeRegistrationActivity.class.getSimpleName() + " :: ";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.setTitle(getResources().getString(R.string.employee_registration_title));
                                ...
                                public void onComplete(@NonNull Task<DataSnapshot> task) {
                                    if (task.isSuccessful()) {
                                        if (task.getResult().exists()) {
                                            Intent intent = new Intent(EmployeeRegistrationActivity.this,
                                                    EmployeeMapActivity.class);
        ...
        as_an_employer.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(EmployeeRegistrationActivity.this,
    ...
    private void performRegistration() {
        ...
        mAuth.createUserWithEmailAndPassword(email, password)
                .addOnCompleteListener(EmployeeRegistrationActivity.this, new OnCompleteListener<AuthResult>() {
                    @Override
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (!task.isSuccessful()) {
                            String error = task.getException().toString();
                            Toast.makeText(EmployeeRegistrationActivity.this, "Registration Failed: \n" + error, Toast.LENGTH_SHORT).show();
                            loader.dismiss();
                        } else {
                            ...
                            userDatabaseRef
                                    ...
                                    .addOnCompleteListener(EmployeeRegistrationActivity.this, new OnCompleteListener<Void>() {
                                        @Override
                                        public void onComplete(@NonNull Task<Void> task) {
                                            if (task.isSuccessful()) {
                                                Toast.makeText(EmployeeRegistrationActivity.this, "your have successfully registered", Toast.LENGTH_SHORT).show();
                                                Log.e(TAG, "onComplete", task.getException());
                                                loader.dismiss();
                                                Intent intent = new Intent(EmployeeRegistrationActivity.this, EmployeeMapActivity.class);
                                                startActivity(intent);
                                                finish();
                                            } else {
                                                if(task.getException()!= null){
                                                    ...
                                                    loader.dismiss();
                                                    Toast.makeText(EmployeeRegistrationActivity.this, "Details upload Failed: " + error, Toast.LENGTH_SHORT).show();
